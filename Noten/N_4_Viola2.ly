...
KyrieViolaIIIncipit = \markup {
	"Viola II" \hspace #-18 \score {
		\new Staff \with {
...
% 		\clef "treble_8"
		...
		b %50
		b\fermata \bar "||"
		\time 4/4 \tempoEtIncarnatus \newSpacingSection r8 es\pE es es r f f f
		r d d d r es es es
		r h h h r c c c
		r c c c r d d d %55
		r b b b r b b b
		...
		c2 h4 a
		g4. g8 g2 \bar "||"
		\time 3/4 \tempoCuiusRegni r4 h\fE h %120
		c c r8 h
		c4 c r8 h
		c2 c4
		b2.
