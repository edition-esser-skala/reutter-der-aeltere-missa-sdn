...
GloriaAltoNotes = {
	\relative c' {
		...
		f2 f4 r %15
		R1*11 %26
		r8 \mvTr d(\pE^\solo g4.)^\critnote f16 es f4~
...
GloriaAltoLyrics = \lyricmode {
	...
	pro -- pter __ ma -- gnam glo --
	ri -- am __
	tu -- am. %15
	
	Do -- mi -- ne De -- %27
	us, __ A -- gnus De -- i, Fi --
	li -- us Pa -- _
	_ _ _ %30
	tris. Qui tol -- lis
	pec -- ca -- ta mun -- di,
...
CredoAltoNotes = {
	\relative c' {
		...
		d4.\trill d8 c2 %65
		R1*2 \bar "||"
		\time 4/4 \newSpacingSection \tempoCrucifixus \mvTr es2\fE^\tuttiE f
		g4 as8([ g)] f4 b8([ as)]
		g4 f8([ es)] f2 %70
		g4 r r2
		R1*2
		...
		c4. h8 h2 \bar "||"
		\time 3/4 \tempoCuiusRegni r4 g'\fE g %120
		g g r8 g
		g4 g r8 g
		g2 as4
		f2 g4(
