		...
		\score {
			\new StaffGroup {
				\new Staff {
					...
					\compressFullBarRests \KyrieViolaII
				}
			}
		}
	}
	\bookpart {
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\set Staff.instrumentName = "Viola II"
					\compressFullBarRests \GloriaViolaII
				}
			}
		}
	}
	\bookpart {
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\set Staff.instrumentName = "Viola II"
					\compressFullBarRests \CredoViolaII
				}
			}
		}
	}
	\bookpart {
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\set Staff.instrumentName = "Viola II"
					\compressFullBarRests \SanctusViolaII
				}
			}
		}
	}
	\bookpart {
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\set Staff.instrumentName = "Viola II"
					\compressFullBarRests \BenedictusViolaII
				}
			}
		}
	}
	\bookpart {
		...
		\score {
			\new StaffGroup {
				\new Staff {
					\set Staff.instrumentName = "Viola II"
					\compressFullBarRests \AgnusDeiViolaII
				}
			}
		}
	}
